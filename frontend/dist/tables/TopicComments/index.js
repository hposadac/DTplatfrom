...
import { topicCommentsTemplate } from "./src/template";
/**
 ...
 */
export const topicComments = (state, autoUpdate = true) => {
    const element = BUI.Component.create(topicCommentsTemplate, state);
    if (autoUpdate) {
        const { topic } = state;
