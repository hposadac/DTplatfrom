...
import { classificationTreeTemplate, } from "./src/template";
/**
 ...
 */
export const classificationTree = (state, autoUpdate = true) => {
    const element = BUI.Component.create(classificationTreeTemplate, state);
    if (autoUpdate) {
