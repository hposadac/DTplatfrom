...
import { worldsConfigurationTemplate, } from "./src/template";
/**
 ...
 */
export const worldsConfiguration = (state, autoUpdate = true) => {
    const element = BUI.Component.create(worldsConfigurationTemplate, state);
    if (autoUpdate) {
