...
export const getModelUnit = async (model, type) => {
    const units = Object.values((await model.getAllPropertiesOfType(WEBIFC.IFCUNITASSIGNMENT)))[0];
    let unit;
