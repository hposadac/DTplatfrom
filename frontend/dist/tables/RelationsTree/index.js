...
import { relationsTreeTemplate } from "./src/template";
/**
 ...
 *
 */
export const relationsTree = (state, autoUpdate = true) => {
    const element = BUI.Component.create(relationsTreeTemplate, state);
    if (autoUpdate) {
