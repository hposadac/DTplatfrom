...
export const modelsListTemplate = (state) => {
    ...
    const onTableCreated = (e) => {
        ...
        table.dataTransform = {
            ...
            `;
                ...
                let viewDefinitionTagTemplate;
                if (viewDefinitionTag && "viewDefinition" in model.ifcMetadata) {
                    const viewDefinition = model.ifcMetadata.viewDefinition;
                ...
                if (downloadBtn) {
                    const onSaveClick = () => {
                        ...
                        input.addEventListener("change", async () => {
                            ...
                            const modifiedBuffer = await propsManager.saveToIfc(model, new Uint8Array(originalBuffer));
